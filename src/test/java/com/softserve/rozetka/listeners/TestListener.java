package com.softserve.rozetka.listeners;
...
public class TestListener extends  BaseRunner implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        WebDriver driver = ((BaseRunner) testClass).getDriver();
