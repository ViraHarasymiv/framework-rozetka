...
public class LoginPageElements {
    ...
    private static By errorEmailOrPhoneField = By.xpath("/html/body/app-root/rz-single-modal-window/div[3]/div[2]/rz-user-identification/rz-auth/div/form/fieldset/div[1]/p");
    ...
    public static By getErrorInvalidEmailOrPhoneField(){return LoginPageElements.errorEmailOrPhoneField;}
